...
public class DaysDataController {
    ...
    public ResultJson getByRange(@PathVariable Date start, @PathVariable Date end, PageRequest pageQuery) {
        try {
            PageResult pageResult = daysDataService.getByRange(start, end, pageQuery);
    ...
    public ResultJson getEchartsByRange(@PathVariable Date start, @PathVariable Date end) {
        try {
            Map<String, Object> data = daysDataService.getByRangeOnEcharts(start, end);
